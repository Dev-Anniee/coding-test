...
<p style="user-select: auto !important;">각 세대별 자식이 없는 개체의 수(<code style="user-select: auto !important;">COUNT</code>)와 세대(<code style="user-select: auto !important;">GENERATION</code>)를 출력하는 SQL문을 작성해주세요. 이때 결과는 세대에 대해 오름차순 정렬해주세요. 단, 모든 세대에는 자식이 없는 개체가 적어도 1개체는 존재합니다.</p>
...
<p style="user-select: auto !important;">각 세대별 대장균의 ID는 다음과 같습니다.</p>

<p style="user-select: auto !important;">1 세대 : ID 1, ID 2<br style="user-select: auto !important;">
2 세대 : ID 3, ID 4, ID 5<br style="user-select: auto !important;">
3 세대 : ID 6, ID 7<br style="user-select: auto !important;">
4 세대 : ID 8</p>

<p style="user-select: auto !important;">이 때 각 세대별 자식이 없는 대장균의 ID는 다음과 같습니다.</p>

<p style="user-select: auto !important;">1 세대 : ID 1<br style="user-select: auto !important;">
2 세대 : ID 3, ID 5<br style="user-select: auto !important;">
3 세대 : ID 7<br style="user-select: auto !important;">
4 세대 : ID 8</p>

<p style="user-select: auto !important;">따라서 결과를 세대에 대해 오름차순 정렬하면 다음과 같아야 합니다.</p>
<table class="table" style="user-select: auto !important;">
        <thead style="user-select: auto !important;"><tr style="user-select: auto !important;">
<th style="user-select: auto !important;">COUNT</th>
<th style="user-select: auto !important;">GENERATION</th>
</tr>
</thead>
        <tbody style="user-select: auto !important;"><tr style="user-select: auto !important;">
<td style="user-select: auto !important;">1</td>
